...
const theme = merge(tailwind, {
  ...
  colors: {
    ...
    icon_pink: tailwind.colors.pink[7],
    icon_purple: tailwind.colors.purple[4],
    icon_green: tailwind.colors.green[5],
    modes: {
      light: {
        text: tailwind.colors.black[8],
        heading: tailwind.colors.black[8],
        primary: tailwind.colors.orange[6],
        background: tailwind.colors.gray[5],
        divider: tailwind.colors.gray[3],
        textMuted: tailwind.colors.black[6],
        icon_brightest: tailwind.colors.gray[1],
        icon_darker: tailwind.colors.gray[3],
        icon_darkest: tailwind.colors.gray[5],
      },
    },
  },
